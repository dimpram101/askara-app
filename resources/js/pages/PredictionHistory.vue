...
<template>
   <Head title="My Prediction History" />

   <AppLocalLayout>
      <div class="container mx-auto space-y-6 p-6 max-w-7xl">
         <!-- Header -->
            ...
            <div class="flex items-center gap-3">
               ...
               <div>
                  ...
                  <p class="text-sm text-muted-foreground">
                     View your CXR AI diagnosis history
                  </p>
               </div>
            </div>
         </div>
                        ...
                        <tr v-if="predictions.data.length === 0">
                           ...
                           >
                              <div class="flex flex-col items-center gap-2">
                                 ...
                                 <p class="text-sm">
                                    Start by getting your first CXR AI
                                    diagnosis
                                 </p>
                              </div>
                           </td>
         ...
         <DialogContent class="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div v-if="selectedPrediction" class="space-y-6">
               ...
               >
                  ...
                  <div class="rounded-lg border p-4 text-sm bg-yellow-50 dark:bg-yellow-950 border-yellow-200 dark:border-yellow-800">
               ...
               <!-- Disclaimer -->
               <div class="rounded-lg border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-950 p-4">
                  <p class="text-sm text-orange-800 dark:text-orange-200">
                     <strong>Disclaimer:</strong> This AI diagnosis is for
                     reference purposes only and should not replace professional
